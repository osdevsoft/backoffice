...
//    {
//
//        if (isset($this->config['backoffice']['pagination']['display_mode'])) {
//            $vars['mode'] = $this->config['backoffice']['pagination']['display_mode'];
//        } else {
//            $vars['mode'] = 'pages';
//        }
//
//        if (isset($this->config['backoffice']['pagination']['items_per_page'])) {
//            $items_per_page = $this->config['backoffice']['pagination']['items_per_page'];
//        } else {
//            $items_per_page = 10;
//        }
//
//        if (isset($this->config['backoffice']['pagination']['pages_per_page'])) {
//            $pages_per_page = $this->config['backoffice']['pagination']['pages_per_page'];
//        } else {
//            $pages_per_page = 10;
//        }
//
...
//    {
//        $template_path = '/var/www/osds/backoffice/vendor/osds/backoffice/assets/theme/templates/';
