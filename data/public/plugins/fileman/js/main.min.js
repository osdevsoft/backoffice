    ...
    this.LoadAll = function(d) {
        ...
        $.ajax({
            ...
            error: function(h,i) {
                ...
                $("#pnlLoadingDirs").hide();
                $("#pnlDirList").show();
                alert(t("E_LoadingAjax5") + " " + RoxyFilemanConf.DIRLIST)
            }
        })
    };
